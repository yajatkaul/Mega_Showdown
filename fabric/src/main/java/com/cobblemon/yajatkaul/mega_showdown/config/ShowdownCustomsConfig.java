...
public class ShowdownCustomsConfig {
    ...
    // Item storage
    public static final List<Fusion> fusionItems = new ArrayList<>();
    public static final List<FormeChange> formeChange = new ArrayList<>();
    public static final List<HeldItem> heldItems = new ArrayList<>();
    public static final List<MegaItem> megaItems = new ArrayList<>();
    public static final List<Gmax> gmax = new ArrayList<>();
    public static final List<KeyItems> keyItems = new ArrayList<>();
