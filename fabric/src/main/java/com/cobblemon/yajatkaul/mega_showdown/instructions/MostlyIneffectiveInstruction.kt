...
class MostlyIneffectiveInstruction(val message: BattleMessage,val instructionSet: InstructionSet): InterpreterInstruction {
    override fun invoke(battle: PokemonBattle) {
        ...
        battle.dispatchGo {
            ...
            if (lastCauser is MoveInstruction && lastCauser.spreadTargets.isNotEmpty()) {
                ...
                battle.broadcastChatMessage(battleLang("mostlyIneffective_spread", pokemonName))
            } else {
                battle.broadcastChatMessage(battleLang("mostlyIneffective"))
            }
