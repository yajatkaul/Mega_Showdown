...
public class Sprites {
    ...
    public static final Item MEGA_MODE_SPRITE = registerItem("mega_mode_sprite", new Item(new Item.Settings()));
    public static final Item BATTLE_BOND_SPRITE = registerItem("battle_bond_sprite", new Item(new Item.Settings()));
