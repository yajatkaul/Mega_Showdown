...
public record MostlyIneffectiveInstruction(
    ...
    public void invoke(@NotNull PokemonBattle pokemonBattle) {
        ...
        pokemonBattle.dispatchGo(() -> {
            ...
            if (lastCauser instanceof MoveInstruction && !((MoveInstruction) lastCauser).getSpreadTargets().isEmpty()) {
                ...
                pokemonBattle.broadcastChatMessage(LocalizationUtilsKt.battleLang("mostlyIneffective_spread", pokemonName).withStyle(ChatFormatting.YELLOW));
            } else {
                pokemonBattle.broadcastChatMessage(LocalizationUtilsKt.battleLang("mostlyIneffective").withStyle(ChatFormatting.YELLOW));
            }
